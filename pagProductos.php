                    ...
                    <div class="sidebar">
                        <div class="filtroProductos">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" placeholder="0.01">
                            </div>
                            <h5 style="text-align: center;"> a</h5>
                            <div class="input-group">
                                <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" placeholder="999.99">
                                <span class="input-group-text">$</span>
                            </div>
                            <h4>Descuentos</h4>
                            <p>Desde 5% OFF(65)</p>
