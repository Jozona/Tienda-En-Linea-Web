  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="list-group">
          <?php
          // $WishAPI = new API_Wishlists;
    
          echo '<a href="./perfil.php?seccion=wishlist"><button type="button" class="list-group-item list-group-item-action active" aria-current="true">
          Crear nueva lista
          </button></a>';
          ?>
</div>
    ...
    <!-- Modal para enviar mensaje a el vendedor -->
  ...
  Launch static backdrop modal
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="media text-muted pt-3">
          <img src="./img/pinata.jpg" alt="32x32" class="mr-9 rounded" data-holder-rendered="true" style="width: 32px; height: 32px;">
        ...
        <div class="media text-muted pt-3">
          <img src="./img/verano.png" alt="32x32" class="mr-9 rounded" data-holder-rendered="true" style="width: 32px; height: 32px;">
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
        ...
        <div class="media text-muted pt-3">
          <img src="./img/productoo.webp" alt="32x32" class="mr-9 rounded" data-holder-rendered="true" style="width: 32px; height: 32px;">
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
